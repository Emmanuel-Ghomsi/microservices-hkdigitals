import "../../../assets/scss/resume/medical-resume.scss";

// Moment JS to format date
import moment from "moment";
import "moment/locale/fr";

export default function MedicalResume(props) {
  return (
    <div id="resume" className="medical-resume" ref={props.componentRef}>
      ...
      <div className="left-section">
        ...
        />
        <div className="infos">
          <h4 className="title">Profil Personnel</h4>
          <p className="summary">
            {props.resume !== null ? props.resume.summary ?? "" : ""}
          </p>
        </div>
        <div className="infos">
          <h4 className="title">Informations personnelles</h4>
      ...
      <div className="right-section">
        ...
        <div className="infos mt-2">
          <h4 className="title">Carrière</h4>
